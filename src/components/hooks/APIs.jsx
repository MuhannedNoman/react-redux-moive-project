...
export const LATEST_MOVIES= `https://api.themoviedb.org/3/movie/latest?api_key=${API_KEY}&language=en-US`
// export const SEARCH_MOVIES= `https://api.themoviedb.org/3/search/movie?api_key=${API_KEY}language=en-US&page=1&include_adult=false&`
